		...
		throw (AsymmetricKeyException)
{
	...
	if (!eckey)
	{
		throw AsymmetricKeyException(AsymmetricKeyException::INTERNAL_ERROR, "ECDSAKeyPair::ECDSAKeyPair");
	}
		...
		throw (AsymmetricKeyException)
{
	...
	if (engine)
	{
		...
		if (!pkey)
		{
			throw AsymmetricKeyException(AsymmetricKeyException::UNAVAILABLE_KEY, "KeyId: " + this->keyId, "ECDSAKeyPair::getPrivateKey");
		}
		try
		{
	...
	else
	{
		...
		if (ret == NULL)
		{
			throw AsymmetricKeyException(AsymmetricKeyException::INVALID_TYPE, "ECDSAKeyPair::getPrivateKey");
		}
